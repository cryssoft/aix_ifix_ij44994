...
#    7.2.5.3    IJ44994s4a.230412.epkg.Z  key_w_fix  <<-- covered here
#    7.2.5.4    IJ44994s4a.230412.epkg.Z  key_w_fix  <<-- covered here
#    7.2.5.5    IJ44994s5a.230307.epkg.Z  key_w_fix  <<-- covered here
...
#    3.1.3.14    IJ45223s4a.230307.epkg.Z  key_w_fix  <<-- covered elsewhere
#    3.1.3.21    IJ45223s4a.230307.epkg.Z  key_w_fix
#    3.1.3.30    IJ45223s4a.230307.epkg.Z  key_w_fix
#    3.1.4.10    IJ44994s5a.230307.epkg.Z  key_w_fix  <<-- covered here
#
#-------------------------------------------------------------------------------
#
class aix_ifix_ij44994 {
    ...
    if ($::facts['osfamily'] == 'AIX') {
        ...
        if (($ifixSuffix != 'unknown') and ($ifixBuildDate != 'unknown')) {
            ...
            unless ($ifixFullName in $::facts['aix_ifix']['hash'].keys) {
                ...
                $ifixStagingSource = "puppet:///modules/aix_ifix_ij44994/${ifixName}${ifixSuffix}.${ifixBuildDate}.epkg.Z"
